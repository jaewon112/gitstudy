...
public class Main {
    public static void main(String[] args) {
        ...
        //매개벼ㅕㄴ수의 자료형을 생략 할 수 있고 변수명 변경 가능
        아무거나가능한인터페이스2 f = (d1,d2)-> {
            return d1 + d2;
        };

        // 재정의 함수 내용이 한줄의 명령이면 {}중괄호를 생략 할 수 있다. 단, 리ㅣ턴이 있는 경우 리터 값만 한줄로 작성해야한다.
        아무거나가능한인터페이스 g = () -> System.out.println("한줄 명령 실행");
        아무거나가능한인터페이스2 g2 = (d1,d2) -> d1+d2;
        // 매개벼수가 하나면 매개변수를 감싸는 ()소괄호를 생략 할 수 있다.
        아무거나가능한인터페이스3 h = data ->"데이터:" + data;
        String h결과 = h.실행("아무데이터");
        // 람다식 정의 할 때 꼭 지켜야하는 조건 -> 무조건 한나의 추상메서드만 정의해야한다.(인터페이스)
    }
}
